...
#endif
#if defined(USE_LIBRETINY)
void DeepSleepComponent::set_wakeup_pin_keep_floating(bool wakeup_pin_keep_floating) {
  this->wakeup_pin_keep_floating_ = wakeup_pin_keep_floating;
}
#endif
...
void DeepSleepComponent::begin_sleep(bool manual) {
  ...
  if (this->wakeup_pin_ != nullptr) {
    ...
    lt_deep_sleep_keep_floating_gpio(this->wakeup_pin_->get_pin(), this->wakeup_pin_keep_floating_);
#else
  ...
  if (wakeup_pins_.size() > 0) {
    ...
    for (WakeUpPinItem item : this->wakeup_pins_) {
      ...
      lt_deep_sleep_keep_floating_gpio(1 << item.wakeup_pin->get_pin(), item.wakeup_pin_keep_floating);
    }
  }
  lt_deep_sleep_enter();
#else
